...
\
\
While in general soil respiration rates were greater with increased precipitation, only desert ecosystems showed a statistically significant increase (p = 0.016, Figure 4A). There was a significant interaction between the duration of studies and the strength and direction of the respiration response in forest and grassland ecosystems (Figure 5). The initial increase in soil respiration decreased over time, more strongly in forests than in grasslands.
\
\
...
```{r Ecosystem_type_effectm include = FALSE}
...
# Effect of soil clay and organic C content
