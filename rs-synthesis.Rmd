...
# Load packages
library(raster) # this needs to come before dplyr load so 'select' isn't masked
library(readr)
library(dplyr)
library(tidyr)
library(ggplot2)
...
#take a peek at missing data, 83 studies in dataset
...
#level ecosystem types by water-limitation
