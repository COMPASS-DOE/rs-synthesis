...
srdb_raw %>%
  select(
    ...
    Rs_annual, Rh_annual, Rs_growingseason, Elevation, Quality_flag
  ) %>%
...
#DOI's confirmed for 80 studies included
...
meta_df %>%
  select("Study_number", "SOC_percent", "SOC_depth", "sg_ocs",
         "BBL_notes", "Clay_percent", "Clay_depth", "sg_clay",
         "Ecosystem_type") -> soil_content
