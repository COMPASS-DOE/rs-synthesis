...
meta_manip %>% 
  ...
  left_join(meta_control, 
            by = c("Study_number", "Study_midyear", "Ecosystem_type",
                   "Latitude", "Meas_method", "Species", "Soil_type", "Soil_drainage",
                   "Elevation", "depvar")) %>% 
...
#temporary code with Manipultion_level is incorporated into matching criteria
#currently gives 26 rows, should be 10
check <- meta_df[meta_df$Study_number == 1421,]
```
