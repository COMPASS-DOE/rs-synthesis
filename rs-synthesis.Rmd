...
srdb_raw %>% 
  select(Study_number, Record_number, Author, Study_midyear, Latitude, Ecosystem_type, 
         ...
         Rs_annual, Soil_drainage, Elevation, Rh_annual, Rs_growingseason) -> srdb
...
read_csv("rs/Variance and N - Water manipulations.csv", skip = 2, col_types = "iicdcccdcccdddddddc") %>% 
