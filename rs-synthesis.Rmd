...
ggplot(data = world) +
  ...
  geom_point(data = meta_coords, aes(x = Longitude, y = Latitude, color = Ecosystem_type), size = 2) +
...
```{r alt_dist_manip}
#alt plot
ggplot(metadat, aes(Percent_control)) +
  xlab("Percent of MAP") +
  geom_histogram(
    na.rm = TRUE,
    position = "stack",
...
```{r Soil_grid_clay, fig.cap = " Clay content was not a strong predictor of soil respiration resonse to precipitation change.", echo = FALSE}
